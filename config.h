...
const char *spcmd2[] = {TERMINAL, "-n", "spcalc", "-f", "monospace:size=16", "-g", "50x20", "-e", "genius", NULL };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,		XK_r,		spawn,		SHCMD(TERMINAL " -e lf-img") },
	...
	{ MODKEY|ShiftMask,		XK_n,		spawn,		SHCMD("samedir") },
